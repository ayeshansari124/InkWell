...
<div className="relative hidden sm:block w-full max-w-sm">
  ...
  {/* LIVE RESULTS */}
  {results.length > 0 && (
    <div className="absolute top-[52px] left-0 w-full bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
      {results.map((author) => (
        <Link
          key={author._id}
    ...
    <>
      ...
      <button
        ...
        className="
          ...
          border hover:ring-2 hover:ring-black
          transition
        "
        title="My Profile"
      >
